...
exports.getAllAccounts = async (req, res, next) => {
    ...
    let queryAccounts = Account.find(JSON.parse(queryObjectString));
    ...
    if(req.query.sort) {
        queryAccounts = queryAccounts.sort(req.query.sort)
    }
    ...
    if(req.query.fields){
        ...
        queryAccounts = queryAccounts.select(fieldsArray)
    ...
    queryAccounts = queryAccounts.skip(documentsToSkip).limit(pageSize);

    console.log(queryAccounts.toString());
